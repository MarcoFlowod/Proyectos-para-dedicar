const proyectos = [
    ...
    },
    {
        ...
        url: "./Proyectos♥/coleción-de-imágenes/index.html",
        imagen: "./assets/img/imagen-2.webp",
        alt: "Colección de imágenes con efecto flip y zoom interactivo",
        layout: "wide"
    },
    {
        id: 3,
    ...
    },    
    {
        ...
        url: "./Proyectos♥/galaxia-de-fotos/index.html",
    ...
    },    
    {
        ...
        url: "./Proyectos♥/feliz-cumpleaños/index.html",
    ...
    },
    {
        ...
        url: "./Proyectos♥/carta-para-dedicar/index.html",
        imagen: "./assets/img/imagen-6.webp",
        alt: "Carta para dedicar con efectos visuales y animaciones",
        layout: "tall"
    },
    {
        id: 7,
...
function cargarProyectos() {
    ...
    const html = proyectos.map(p => `
        <a class="grid-item ${p.layout || ''}" 
           href="${p.url}" 
           target="_blank" 
           rel="noopener noreferrer"
           role="article" 
           aria-labelledby="proyecto${p.id}-title">
            ...
            <div class="text-content">
                ...
                <div class="btn-icons">
                    <button class="btn-ver" type="button" onclick="window.open('${p.url}','_blank','noopener'); event.stopPropagation();">
                        <i class="fas fa-eye"></i>
                        <span class="btn-text">Ver</span>
                    </button>
                    <button class="btn-dedicar" 
